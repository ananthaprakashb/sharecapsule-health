...
export function HomePage({ onOpenActivity, onOpenRoutines, onOpenProgress, onOpenCheckin }: HomePageProps) {
  ...
  return <main className="page-shell phase3-home"><header className="app-header"><div><p className="eyebrow">ShareCapsule</p><h1>Health</h1></div><span className="brand-mark" aria-hidden="true">♥</span></header>
    ...
    <section className="phase7-checkin-card"><div><p className="eyebrow">How are you?</p><h2>Voice check-in</h2><p>Say how you feel, then confirm the label yourself.</p></div><button type="button" onClick={onOpenCheckin}>Check in</button></section>
